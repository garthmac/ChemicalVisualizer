...
class Atoms {  // https://en.wikipedia.org/wiki/Van_der_Waals_radius   http://periodictable.com/Properties/A/VanDerWaalsRadius.an.html
    ...
    class func chlorineAtom() -> SCNGeometry {  //17
        ...
        chlorineAtom.name = wiki() + "Chlorine"
    ...
    class func fluorineAtom() -> SCNGeometry {  //9
        ...
        fluorineAtom.name = wiki() + "Fluorine"
    ...
    class func hydrogenAtom() -> SCNGeometry {  //1
        ...
        hydrogenAtom.name = wiki() + "Hydrogen"
    ...
    class func magnesiumAtom() -> SCNGeometry {  //12
        ...
        magnesiumAtom.name = wiki() + "Magnesium"
    ...
    class func nitrogenAtom() -> SCNGeometry {  //7
        ...
        nitrogenAtom.name = wiki() + "Nitrogen"
    ...
    class func palladiumAtom() -> SCNGeometry {  //46
        ...
        palladiumAtom.name = wiki() + "Palladium"
    ...
    class func phosphorusAtom() -> SCNGeometry {  //15
        ...
        phosphorusAtom.name = wiki() + "Phosphorus"
    ...
    class func platinumAtom() -> SCNGeometry {  //78
        ...
        platinumAtom.name = wiki() + "Platinum"
    ...
    class func potassiumAtom() -> SCNGeometry {  //19
        ...
        potassiumAtom.name = wiki() + "Potassium"
...
//        potassiumAtom.firstMaterial!.fresnelExponent = 2
    ...
    class func seleniumAtom() -> SCNGeometry {  //34
        ...
        seleniumAtom.name = wiki() + "Selenium"
    ...
    class func telluriumAtom() -> SCNGeometry {  //52
        ...
        telluriumAtom.name = wiki() + "Tellurium"
    ...
    class func thalliumAtom() -> SCNGeometry {  //81
        ...
        thalliumAtom.name = wiki() + "Thallium"
    ...
    class func allAtoms() -> SCNNode {
        ...
        siliconNode.position = SCNVector3Make(+4, -3.7, 0)
        ...
        sulfurNode.position = SCNVector3Make(-5.6, -8, 0)
